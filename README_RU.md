# GeoRestrict - Продвинутый GeoIP middleware для Laravel
...
🚀 Production-ready контроль доступа по геолокации для Laravel-приложений
...
- 🌍 Фильтрация по геолокации (страна, регион, город, ASN, ISP)
- 🔀 Поддержка нескольких GeoIP-провайдеров с fallback
- ⚡ Встроенное кеширование для повышения производительности
- 🚦 Ограничение запросов к GeoIP-сервисам (rate limiting)
- 🧠 Гибкие правила allow/deny с callback-функциями
- ⏱ Ограничения по времени
- 📍 Применение на уровне маршрутов (patterns + HTTP методы)
- 🛡 Белый список IP-адресов
- 🌐 Многоязычные ответы об ошибках
- 📊 Логирование разрешённых и заблокированных запросов
...
Файл конфигурации позволяет полностью настроить поведение GeoRestrict.

## Пример `config/geo-restrict.php`
