...
class GeoRestrictMiddlewareTest extends TestCase
{
    ...
    public function test_blocked_country_gets_403_and_localized_message()
    {
        ...
        $response->assertSee(Lang::get('geo_restrict::messages.blocked'));
    }
    ...
    {
        Config::set('geo_restrict.access.rules.deny.country', ['US']);
        $this->setMockGeoData([
            'country' => 'US',
            'region' => 'California',
            'city' => 'Los Angeles',
    ...
    {
        Config::set('geo_restrict.access.rules.allow.country', ['RU']);
        Config::set('geo_restrict.access.rules.deny.city', ['Moscow']);
        $this->setMockGeoData([
            'country' => 'RU',
            'region' => 'Moscow',
            'city' => 'Moscow',
    ...
    public function test_json_response_type()
    {
        ...
        $response = $this->get('/test', ['X-Forwarded-For' => '8.8.8.8']);
        $response->assertStatus(403);
        $response->assertJsonFragment(['message' => Lang::get('geo_restrict::messages.blocked')]);
    }
    ...
    public function test_view_response_type()
    {
        ...
        $response->assertViewHas('message', Lang::get('geo_restrict::messages.blocked'));
    }
    ...
    {
        Config::set('geo_restrict.routes.only', ['admin/*']);
        Config::set('geo_restrict.access.rules.deny.country', ['US']);
        $this->setMockGeoData([
            'country' => 'US',
            'region' => 'California',
    ...
    {
        Config::set('geo_restrict.routes.except', ['public/*']);
        Config::set('geo_restrict.access.rules.deny.country', ['US']);
        $this->setMockGeoData([
            'country' => 'US',
            'region' => 'California',
    ...
    {
        Config::set('geo_restrict.routes.methods', ['POST']);
        Config::set('geo_restrict.access.rules.deny.country', ['US']);
        $this->setMockGeoData([
            'country' => 'US',
            'region' => 'California',
    ...
    {
        Config::set('geo_restrict.logging.blocked_requests', true);
        Config::set('geo_restrict.logging.allowed_requests', true);
        Config::set('geo_restrict.access.rules.deny.country', ['US']);
        $this->setMockGeoData([
            'country' => 'US',
            'region' => 'California',
